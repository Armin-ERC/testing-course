package com.aerc.cursotestingandroid.productlist.data.local.database.dao
...
interface PromotionDao {
    ...
    @Transaction
    suspend fun replaceAll(products: List<PromotionEntity>) {
        clearPromotions()
        insertAllPromotions(products)
    }
}
